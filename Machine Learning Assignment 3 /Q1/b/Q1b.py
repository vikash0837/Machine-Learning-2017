...
def k_c_validate(k_f, training_model, traindata_x, traindata_y):
    ...
    for i in range(k_f):
        ...
        training_model.fit(traindata_training_x, traindata_training_y,5)
...
class NN:
    ...
    def fit(self,x,y,it):
        ...
        #last weight 50x1
        self.weight.append(np.random.uniform(low=-1.0, high=1.0, size=(self.layer[-1],10)))
        self.basis.append(np.random.uniform(low=-1.0, high=1.0, size=(1,10)))
        #print self.weight[-1].shape
...
def load_h5py(filename):
    with h5py.File(filename, 'r') as hf:
        ...
        Y = hf['Y'][:]
    return X, Y
X = idx2numpy.convert_from_file('/home/jarvis/Desktop/Machine Learning Assignment 3 (2)/Dataset/train-images.idx3-ubyte')
Y =idx2numpy.convert_from_file('/home/jarvis/Desktop/Machine Learning Assignment 3 (2)/Dataset/train-labels.idx1-ubyte')

X_t = idx2numpy.convert_from_file('/home/jarvis/Desktop/Machine Learning Assignment 3 (2)/Dataset/t10k-images.idx3-ubyte')
Y_t =idx2numpy.convert_from_file('/home/jarvis/Desktop/Machine Learning Assignment 3 (2)/Dataset/t10k-labels.idx1-ubyte')
...
# plt.show()
nn.fit(x=x_f,y=y_f,it=8)
print nn.score(x_t,y_t)

joblib.dump(nn,'Model1/logistic_softmax_0_1.sav')
'''

nn=joblib.load('logistic_softmax_0_1.sav')
print nn.score(x_t,y_t)
